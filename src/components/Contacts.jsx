...
const Contacts = () => {
  return (
    <div id='contacts' className='flex min-h-screen w-full flex-col items-center justify-center gap-16 p-8 '>
    ...
    <h1 className='text-center text-6xl font-light text-blue-600'>Get in Touch</h1>
      ...
      <form className='flex w-full max-w-md flex-col gap-8 rounded-lg p-6 md:max-w-lg lg:max-w-xl'>
        ...
        <button className='rounded-lg border-2 border-blue-400 bg-blue-500 px-6 py-3 font-semibold text-white transition-all duration-200 hover:bg-blue-600'>Send Message</button>
      </form>
    </div>
  )
}
