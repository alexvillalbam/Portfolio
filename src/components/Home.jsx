    ...
    <div
      ...
      <div className='flex flex-col items-center justify-center gap-8 p-5 text-center'>
        ...
        <div className='space-y-1 sm:space-y-3'>
          ...
          <h3 className='bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-xl font-semibold text-transparent md:text-2xl lg:text-3xl'>
            Desarrollador Web
          </h3>
          <p className='max-w-[500px] text-sm text-gray-500'>
            Soy un desarrollador web apasionado por crear experiencias digitales
            atractivas. Me encanta convertir ideas en proyectos reales
            utilizando React y JavaScript, y estoy constantemente experimentando
            con nuevas tecnologías para mejorar mi oficio.
          </p>
        </div>
        ...
        <div className='flex gap-3'>
          <a
            ...
            <BiLogoGithub className='h-10 w-10 cursor-pointer rounded-full border-2 border-transparent bg-blue-600 p-2 text-white transition-all duration-200 hover:scale-110 hover:border-blue-600 hover:bg-white hover:text-blue-600 md:h-12 md:w-12 ' />
          </a>
          <a
